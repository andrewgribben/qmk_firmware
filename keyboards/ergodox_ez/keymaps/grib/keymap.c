...
#define KC_LTAB LT(SYMB, KC_TAB)
#define KC_LLCT LCTL_T(KC_LPRN)
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_BSPC,        KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_EQL,
        LT(VIMISH,KC_TAB),        KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_VOLU,
        ...
        // right hand
             ...
             KC_LSCR,KC_N,   KC_M,  KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                                  KC_UP,KC_DOWN,KC_HYPR, KC_RALT,         KC_RRCT,
             KC_INS,        KC_DELT,
             KC_PGUP,
             KC_PGDN,KC_RENT,KC_SALT  
    ),
    

    [YTREWQ] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_BSPC,        KC_0,   KC_9,   KC_8,   KC_7,   KC_6,   KC_MINS,
        LT(SYMB,KC_RQUO),KC_P,   KC_O,   KC_I,   KC_U,   KC_Y,   KC_PAUSE,
        LT(MDIA,KC_QUOT),KC_SCLN,   KC_L,   KC_K,   KC_J,   KC_H,
        KC_RSFT,        KC_SLSH,   KC_DOT,   KC_COMM,   KC_M,   KC_N,   KC_LSCR,
        KC_RRCT, KC_LALT, KC_HYPR,KC_LEFT,KC_RGHT,
                                               KC_DELT,  KC_INS,
                                                              KC_PGUP,
                                               KC_SALT,KC_RENT,KC_PGDN,
        // right hand
             KC_MINS,     KC_6,   KC_7,  KC_8,   KC_9,   KC_0,             KC_BSPC,
             KC_PAUSE,    KC_Y,   KC_U,  KC_I,   KC_O,   KC_P,             LT(SYMB,KC_RQUO),
                          KC_H,   KC_J,  KC_K,   KC_L,   KC_SCLN,          LT(MDIA,KC_QUOT),
